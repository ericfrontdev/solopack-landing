        ...
        <section className="py-24 md:py-32 relative overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-xl md:text-2xl text-primary-foreground/90 mb-12 max-w-3xl mx-auto border-l">
              SoloPack est la plateforme la plus simple pour gérer votre
              entreprise : clients, factures, projets, paiements et comptabilité
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              ...
              <div className="group p-8 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg">
                ...
                <h3 className="text-xl font-semibold mb-3">CRM complet</h3>
              ...
              <div className="group p-8 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg">
                ...
                <h3 className="text-xl font-semibold mb-3">
                  Facturation professionnelle TPS/TVQ
                </h3>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="group p-8 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg">
                ...
                <h3 className="text-xl font-semibold mb-3">
                  Comptabilité simple et rapports
                </h3>
                <p className="text-muted-foreground leading-relaxed">
